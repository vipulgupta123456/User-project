class PhonesController < ApplicationController
  ...
  def index
    ...
    @phones = Phone.where(user_id:$useraa.id)
    
	render "index",:layout=>'sessions_inside'
  ...
  # GET /phones/1.json
  def show
  @phone =  Phone.where(user_id:$useraa.id)
render "show",:layout=>'sessions_inside'
  end
  def account_summary
  end
